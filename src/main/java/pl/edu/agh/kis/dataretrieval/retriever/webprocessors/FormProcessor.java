...
public class FormProcessor {
	...
	private static boolean iterateUsedValues(List<FormFieldData> fieldDataList) {
		...
		while (iterated == false && i < fieldDataList.size()) {
			...
			if (!fieldData.getAlternativeDefaultValues().isEmpty()) {
				if (fieldData.getUsedValues().containsAll(
		...
		if (iterated == false) { // jeœli przesz³o wszystkie wêz³y resetuj¹c je
	...
	public void setDefaultValues(List<FormFieldData> fieldDataList,
			boolean bulkMode) {
	...
	private void setEveryValues(FormFieldData fieldData){
		fieldData.addDefaultValues(fieldData.getOptionValues());
	}
	
	private void setAllValues(FormFieldData fieldData){
	...
	private void setAllUsedValues(FormFieldData fieldData){
		List<String> options = fieldData.getOptionValues();
		if (!options.isEmpty()){
	...
	private List<String> renameDefaultValues(FormFieldData fieldData, List<String> defaultValues){
		if (fieldData.getOptionsDescriptions().isEmpty()){

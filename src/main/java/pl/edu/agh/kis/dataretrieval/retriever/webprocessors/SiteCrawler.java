...
public class SiteCrawler{
	 ...
	 */
	public static Map<String, List<DbFieldData>> readData(WebResponse response, List<CrawlingData> configNodes) throws DOMException, RetrievalException, SAXException, XPathExpressionException, IOException{
	...
	private static Object goThroughPath(CrawlingData configNode, Node node) throws DOMException, RetrievalException{
		if (node != null){
	...
	private static Object getPathRecord(NamedNodeMap attrs, Node node, CrawlingData configNode) throws DOMException, RetrievalException{
	...
	private static Object getData(NamedNodeMap attrs, Node node, CrawlingData configNode){

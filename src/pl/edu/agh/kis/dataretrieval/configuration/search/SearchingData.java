...
//	java data
	...
	public SearchingData(String fieldName, List<String> options) {
		super();
		this.fieldName = fieldName;
		this.options = options;
	}

	public SearchingData(String fieldName) {
		super();
		this.fieldName = fieldName;
	}

	public SearchingData(FieldType javaFieldType, String fieldName) {
		super();
		this.javaFieldType = javaFieldType;
		this.fieldName = fieldName;
	}

	public SearchingData(String fieldName, String description) {
		super();
		this.fieldName = fieldName;
		this.description = description;
	}

	public SearchingData(String fieldName, String description, List<String> options) {
		super();
		this.fieldName = fieldName;
		this.description = description;
		this.options = options;
